...
class PeriodCalculator:
    """Utility class for calculating time period boundaries."""
...
class PeriodTracker:
    ...
    def __init__(self):
        ...
        self._calculator = PeriodCalculator()
    
    def get_current_period(self, period_type: str, budget_limit: float, 
                          current_time: Optional[datetime] = None) -> TimePeriod:
        ...
        # Check if we have this period already
    ...
    def process_period_rollover(self, period_type: str, budget_limit: float,
        ...
        # Find the most recent expired period of this type
        expired_periods = [
        ...
        # Get the most recent expired period
    ...
    def cleanup_old_periods(self, current_time: Optional[datetime] = None,
        ...
        # Remove periods that ended before the cutoff
        to_remove = [
    ...
    def _get_period_boundaries(self, period_type: str, 
        ...
        if period_type == "hourly":
            return self._calculator.get_hourly_period(dt)
        elif period_type == "daily":
            return self._calculator.get_daily_period(dt)
        elif period_type == "weekly":
            return self._calculator.get_weekly_period(dt)
        elif period_type == "monthly":
            return self._calculator.get_monthly_period(dt)
        else:
    ...
    def get_period_summary(self, period_type: str, 
        ...
        # Find current period for this type
        current_periods = [
            period for period in self._periods.values()
            if (period.period_type == period_type and
        ...
        period = current_periods[0]  # Should only be one current period per type
